# Roberto MCP API Reference

This document provides comprehensive API documentation for all MCP tools provided by Roberto MCP.

## 🔧 MCP Tools Overview

Roberto MCP provides 7 MCP tools for comprehensive code analysis:
