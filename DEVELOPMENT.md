...
This guide covers the development workflow, architecture decisions, and contribution guidelines for Roberto MCP.
...
RUST_LOG=roberto_mcp::indexing=trace cargo run
...
rust-gdb target/debug/roberto-mcp
...
# Strip debug symbols
strip target/release/roberto-mcp
```
...
This development guide should help you contribute effectively to Roberto MCP. For questions, please open an issue or start a discussion.
